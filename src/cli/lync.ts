...
export function lyncUsage(): string {
  return [
    ...
    "  --source-ref <ref>         author.source prefix (default: --source; use a portable ref",
    "                             to keep OCR events free of physical source paths)",
    ...
    "  splice lync ocr --source ../deep-space/data/signal-ocr --source-ref archive://signal-ocr --set-locator signal-ocr --out ./out/signal-ocr.lync",
